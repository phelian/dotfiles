...
**Git**: Commit messages should be single-line summaries in lowercase (except proper names), with no compound sentences, footers, or conventional commit prefixes. Never mention Claude in messages.
